define( ["qlik", "css!./UselessBarchart-Christmas.css","./js/d3.min", "./js/senseD3utils", "./js/senseUtils"],
	function ( qlik, template ) {
		...
		return {
			...
			paint: function ($element,layout) {
	            ...
	            html+="<audio src='/extensions/UselessBarchart-Christmas/resource/JingleBell.mp3' autoplay loop></audio>"
	            // html+="<img id='happyManHand' src='/extensions/UselessBarchart/resource/happyManHand.png'></img>"
	            html+="<img id='happyManHand' src='/extensions/UselessBarchart-Christmas/resource/happyManHand.png'></div>"
	            html+="<img id='happyMan' src='/extensions/UselessBarchart-Christmas/resource/happyMan.png'></img>"
	            $element.html(html);
	            viz($('.svgDiv'), layout, self);
	            $('.svgDiv').css({
	            	'background-image': 'url(/extensions/UselessBarchart-Christmas/resource/giphye.gif)',
...
var viz = function($element, layout, _this) {
	...
	plot.selectAll(".bar")
	    ...
	    .enter().append("svg:image")
	      .attr("xlink:href", "/extensions/UselessBarchart-Christmas/resource/rainbow.gif")
